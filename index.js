...
// Fix for mobile initial scaling
document.addEventListener('DOMContentLoaded', function() {
  // Check if mobile view and adjust accordingly
  const checkMobile = function() {
    if (window.innerWidth <= 768) {
      ...
      // Ensure the menu toggle works properly
  ...
  // Fix for initial scale on mobile
  ...
  window.addEventListener('orientationchange', function() {
    // Small timeout to ensure the orientation change is complete
    setTimeout(function() {
